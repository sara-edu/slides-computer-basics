...
<br>
<br>
[Connecting Printers <br>and Other Devices <br>to your PC]{.centering .r-fit-text}
:::

::: {.column width="50%"}
![](https://images.unsplash.com/photo-1616578273577-5d54546f4dec?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fHVzYiUyMHR5cGVzfGVufDB8fDB8fHww){width=400}
:::
...
## Connect protable devices/gadgets to your PC
...
<br>
<br>
[Setting Up<br>a Home Network]{.centering .r-fit-text}
:::

::: {.column width="50%"}
![](https://images.unsplash.com/photo-1569144157596-10825eecdde2?q=80&w=3087&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D){width=400}
:::
...
- Wired network is faster and more secure.

- Wireless network is more convenient (no wires).
...
<br>
<br>
[Internet at Home and Away]{.centering .r-fit-text}
:::
...
- Two ways to send email
  - POP\IMAP: Post Office Protocol/Internet Message Access Protocol - they require a separate email program.
...
## Google Slide {background-color="#000000"}
